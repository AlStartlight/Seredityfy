...
const history = [
  { v: '2.3', time: '3h 15m ago', img: '/assets/card1.png' },
  { v: '2.2', time: '5h ago', img: '/assets/card2.png' },
  { v: '2.1', time: 'Yesterday', img: '/assets/card3.png' },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="relative group rounded-2xl overflow-hidden shadow-2xl shadow-purple-900/40 bg-surface-container-low aspect-[4/5] lg:aspect-auto lg:h-[750px]">
            <img className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Bioluminescent forest" src="/assets/card1.png" />
        ...
        <div className="lg:col-span-4 space-y-6 sticky top-28 h-fit">
          <div className="bg-surface-container-low rounded-3xl p-6 border border-white/5 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl overflow-hidden ring-2 ring-primary/20">
                <img alt="Avatar" className="w-full h-full object-cover" src="/assets/zenai.jpg" />
              </div>
              <div>
          ...
          {/* Tab Navigation with History active */}
          <div className="bg-surface-container-lowest rounded-3xl border border-white/5 overflow-hidden">
            <div className="flex border-b border-white/5 bg-white/5">
              <Link href="/admin/gallery/1" className="flex-1 py-4 text-center text-xs font-bold font-label uppercase tracking-widest text-primary/40 hover:text-primary transition-colors">Details</Link>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-3">
                {history.map((h) => (
                  <div key={h.v} className="flex items-center gap-4 p-3 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors cursor-pointer group">
                    <div className="w-16 h-16 rounded-xl overflow-hidden bg-surface-container-high">
                      <img alt={`v${h.v}`} className="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition-opacity" src={h.img} />
                    </div>
                    <div className="flex-1">
                      <p className="text-sm font-bold text-on-surface">Version {h.v}</p>
                      <p className="text-[10px] text-primary/40 font-label">{h.time}</p>
                    </div>
