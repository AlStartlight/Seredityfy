            ...
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white/5">
                <div className="flex items-center justify-between h-16 ">
                    ...
                    <div className="hidden md:flex ml-auto gap-6 relative z-50">
                        <Link href="/contact" className="px-4 py-2 rounded hover:bg-blue-600 flex flex-inline items-center text-gray-200 pointer-events-auto">
                                Log In
                        </Link>
                        <Link href="/contact" className="group text-sm relative inline-flex items-center  text-white bg-purple-600 px-4 py-2 rounded-sm  shadow pointer-events-none group-hover:pointer-events-auto">
                             Join Now
                        </Link>
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden absolute top-16 left-0 w-full bg-white/90 backdrop-blur-xl border border-gray-200 shadow-lg">
                        <div className="flex flex-col mx-auto items-center p-4">
                            ...
                            <Link href="/contact" className="px-4 py-2 rounded hover:bg-blue-600 flex flex-inline items-center text-gray-700 pointer-events-auto">
                                Log In
                            </Link>
                            <Link href="/contact" className="group text-md relative inline-flex items-center border-2  text-black px-4 py-1 rounded-xl  shadow pointer-events-none group-hover:pointer-events-auto">
                               Sign Up Now
                            </Link>
