  ...
  return (
    <div className='grid grid-cols-[70%_30%] max-w-5xl mx-20 py-20'>
      <div className='flex flex-col justify-center gap-4 items-start mt-20 mb-20'>
        ...
        <h1 className='text-white text-5xl'><span className='text-purple-600'>Target</span><span className='border-0 text-red-500 h-20 w-32'></span> <span>customers </span>with<br/> our powerful AI kit</h1>
      ...
      <img alt='...' src="/weeb/ShapesAI.svg" className='relative top-20 -left-10' width={1000} height={1000}/>
    </div>
  )
}
